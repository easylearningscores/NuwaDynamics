...
class Exp:
    ...
    def _build_model(self):
        args = self.args
        self.model = Fourier_Model(tuple(args.in_shape), args.hid_S,
    ...
    def train(self, args):
        ...
        for epoch in range(config['epochs']):
            ...
            for batch_x, batch_y in train_pbar:
                ...
                pred_y = self.model(batch_x) # B T C H W
    ...
    def vali(self, vali_loader):
        ...
        print_log('L2 error: {:.7f}, Relative L2 error: {:.7f},'.format(l2_error, relative_l2_error))
